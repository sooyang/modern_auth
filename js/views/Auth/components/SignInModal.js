        ...
        <View style={[styles.modalBackground, styles.centerContent, styles.flex]}>
          <View style={styles.box}>
            ...
            <View style={[styles.footer, styles.flexRow]}>
              <TouchableOpacity onPress={() => {onSignUp()}} style={[styles.button, styles.centerContent, styles.flex, styles.flexColumn]} >
                <Text style={styles.font}>
                  Sign Up
                </Text>
              </TouchableOpacity>
              <TouchableOpacity style={[styles.button, styles.centerContent, styles.flex, styles.flexColumn]} onPress={() => { this.logIn() }
